...
| contrast-credential_theft-01 | credential_theft | phishing | 0.0136 | legitimate | 0.9864 | phishing |
| contrast-credential_theft-02 | credential_theft | phishing | 0.0131 | legitimate | 0.9869 | phishing |
| contrast-credential_theft-03 | credential_theft | phishing | 0.0131 | legitimate | 0.9869 | phishing |
| contrast-credential_theft-04 | credential_theft | phishing | 0.0127 | legitimate | 0.9873 | phishing |
| contrast-credential_theft-05 | credential_theft | phishing | 0.1600 | legitimate | 0.8400 | phishing |
| contrast-credential_theft-06 | credential_theft | phishing | 0.0130 | legitimate | 0.9870 | phishing |
| contrast-credential_theft-07 | credential_theft | phishing | 0.0133 | legitimate | 0.9867 | phishing |
| contrast-credential_theft-08 | credential_theft | phishing | 0.0128 | legitimate | 0.9872 | phishing |
| contrast-credential_theft-09 | credential_theft | phishing | 0.0832 | legitimate | 0.9168 | phishing |
| contrast-fake_invoice-01 | fake_invoice | phishing | 0.0154 | legitimate | 0.9846 | phishing |
| contrast-fake_invoice-02 | fake_invoice | phishing | 0.0130 | legitimate | 0.9870 | phishing |
| contrast-fake_invoice-03 | fake_invoice | phishing | 0.0130 | legitimate | 0.9870 | phishing |
| contrast-fake_invoice-04 | fake_invoice | phishing | 0.0131 | legitimate | 0.9869 | phishing |
